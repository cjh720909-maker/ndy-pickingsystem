...
const ROWS_PER_PAGE = 45; // Adjust this number to fit A4 page perfectly
...
async function fetchLoadingData() {
    ...
    try {
        ...
        renderLoadingData(result.data, result.summary, driverInput, startDate);
...
function renderLoadingData(data, summary, searchDriver, printDate) {
    const pagesContainer = document.getElementById('loading-pages-container');
    const summaryCards = document.getElementById('loading-summaryCards');
    ...
    for (let pageNum = 1; pageNum <= totalPages; pageNum++) {
        ...
        html += `
            <div class="print-area bg-white border border-slate-300 shadow-sm mb-8 overflow-hidden mx-auto" style="width: 21cm; min-height: 29.7cm; padding: 0.5cm; box-sizing: border-box;">
